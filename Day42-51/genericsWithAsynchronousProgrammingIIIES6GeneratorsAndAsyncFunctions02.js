...
function pingsGenerator() {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, pingRequest(1)];
            case 1:
                response01 = _a.sent();
...
var pingsIter = pingsGenerator();
console.time('1st Pong');
console.time('2nd Pong');
console.time('3rd Pong');
pingsIter.next().value.then(function (response01) {
    console.log('Response 1 received');
    pingsIter.next(response01).value.then(function (response02) {
        console.log('Response 2 received');
        pingsIter.next(response02).value.then(function (response03) {
