...
// REVIEW: 泛用型別會在 Day 47 討論
// 此處將 ES6 的 Map 物件的 key 註記為 string
// value 註記為 LatLngExpression
...
// Map 可以這樣使用
/*
    districtLatLngMap.get('內湖區'); // => [25.0713177, 121.5866103]
*/
// REVIEW: Map 和 Set 等 ES6 物件也會在 Day 47 討論
